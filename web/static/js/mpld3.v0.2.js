!(function (d3) {
  ...
  mpld3.generate_id = function (N, chars) {
    console.warn(
      'mpld3.generate_id is deprecated. ' + 'Use mpld3.generateId instead.'
    );
  ...
  mpld3_PathCollection.prototype.transformFunc = function (d, i) {
    ...
    var offset =
      d === null || typeof d === 'undefined'
        ? 'translate(0, 0)'
        : 'translate(' +
          this.offsetcoords.xy(d, this.props.xindex, this.props.yindex) +
          ')';
    ...
    if (this.props.markerpath !== null) {
      this.marker =
        this.props.markerpath[0].length == 0
          ...
          : mpld3
              .path()
              .call(this.props.markerpath[0], this.props.markerpath[1]);
    } else {
      this.marker =
  ...
  function mpld3_Axes(fig, props) {
    ...
    this.x = this.xdom = build_scale(this.props.xscale, this.props.xdomain, [
      0,
      this.width,
    ]);
    this.y = this.ydom = build_scale(this.props.yscale, this.props.ydomain, [
      this.height,
      0,
    ]);
