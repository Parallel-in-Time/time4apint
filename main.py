...
parareal.plotSchedule(N=nBlocks, K=[0, 1, 2, 2, 2])
...
pararealSC.plotSchedule(N=nBlocks, K=[0, 1, 2, 2, 2])
...
abj.plotSchedule(N=nBlocks, K=[0, 1, 2, 2, 2])
...
abgs.plotSchedule(N=nBlocks, K=[0, 1, 2, 2, 2])
